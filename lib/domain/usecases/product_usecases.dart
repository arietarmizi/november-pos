...
class SyncAllUserProductsUsecase extends UseCase<Result, String> {
  ...
  Future<Result<int>> call(String params) async =>
      _productRepository.syncAllUserProducts(params);
}
...
class GetUserProductsUsecase extends UseCase<Result, BaseParams> {
  ...
  @override
  Future<Result<List<ProductEntity>>> call(BaseParams params) async =>
      _productRepository.getUserProducts(
        params.param,
...
class GetProductUsecase extends UseCase<Result, int> {
  ...
  @override
  Future<Result<ProductEntity>> call(int params) async =>
      _productRepository.getProduct(params);
}
...
class CreateProductUsecase extends UseCase<Result, ProductEntity> {
  ...
  @override
  Future<Result<int>> call(ProductEntity params) async =>
      _productRepository.createProduct(params);
}
...
class UpdateProductUseCase extends UseCase<Result<void>, ProductEntity> {
  ...
  @override
  Future<Result<void>> call(ProductEntity params) async =>
      _productRepository.updateProduct(params);
}
...
class DeleteProductUsecase extends UseCase<Result<void>, int> {
  ...
  Future<Result<void>> call(int params) async =>
      _productRepository.deleteProduct(params);
}
